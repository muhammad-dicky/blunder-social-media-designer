...
//                }
    ...
    private fun updloadImageAndUpdateInfo()
    {


        when{
            imageUri == null -> Toast.makeText(this, "please select image", Toast.LENGTH_LONG).show()
            TextUtils.isEmpty(full_name_profile_frag.text.toString()) -> Toast.makeText(this, "full name is required", Toast.LENGTH_LONG).show()
            username_profile_frag.text.toString() == "" -> Toast.makeText(this, "user name is required", Toast.LENGTH_LONG).show()
            bio_profile_frag.text.toString() == "" -> Toast.makeText(this, "bio is required", Toast.LENGTH_LONG).show()
        else -> {
